    ...
    ================================================== -->
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">         
            <img src="${urlResources }/images/slide1.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlResources }/images/slide2.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlResources }/images/slide3.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlResources }/images/slide4.jpg" alt="Slide" title="Some text" >
          </div>
        </div>
      ...
      <div class="row page-header">          
        <div class="col-lg-12">         
          ...
          <form class="form-inline" action="${urlRoot }buscar_fecha" method="POST">
            <div class="form-group">
              <label for="fecha">Fecha: </label>
              <select id="fecha" name="fecha" class="form-control">
              	<core:forEach items="${fechas }" var="fecha">
              		<core:choose>
              			<core:when test="${fecha_actual eq fecha }">
      ...
      <div class="container marketing">
        ...
        <core:forEach items="${peliculas }" var="pelicula" >
          <div class="col-xs-12 col-sm-6 col-md-3">
            <img class="img-rounded" src="${urlResources }/images/${pelicula.imagen}" alt="Generic placeholder image" width="150" height="200">
            ...
            <p><a class="btn btn-sm btn-primary" href="${urlRoot }detalle/${pelicula.id}/${fecha_actual}" role="button">Consulta Horarios &raquo;</a></p>
          </div>
          </core:forEach>
