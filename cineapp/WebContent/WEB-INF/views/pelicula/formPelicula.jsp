...
<html lang="en">
  ...
  <body>
	...
	<h3 class="blog-title"><span class="label label-success">Datos de la Pelicula</span></h3>
      ...
      <tags:hasBindErrors name="pelicula">
      	<div class="alert alert-danger" role="alert">
      		Por favor corrige estos errores!!!
      		<ul>
	      		<core:forEach items="${errors.allErrors }" var="error">
	      			<li>
	      				<tags:message message="${error }"></tags:message>
	      			</li>
	      		</core:forEach>
      		</ul>
      	</div>
      ...
      <form action="${urlRoot }pelicula/guardar" method="POST">
        <div class="row">
          <div class="col-sm-3">
	  ...
	  ${id }<br>
	  ${titulo }<br>
	  <fmt:formatDate value="${fecha_estreno }"/> 
      <hr class="featurette-divider">
